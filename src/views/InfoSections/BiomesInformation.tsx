				...
				<>
					...
					>
						<div className="flex flex-col w-full items-center justify-center gap-y-4">
							...
							<div className="w-full flex flex-wrap overflow-y-scroll h-156 my-5 gap-4 justify-center">
								{filteredDatas.map((data) => {
									return (
										<article
											key={data.id}
											className="flex flex-col gap-x-1 w-full sm:w-[48%] lg:w-[32%] mx-1 bg-green-600 rounded-2xl border-3 border-green-900
											overflow-hidden justify-center max-h-90"
										...
										>
											...
											<CopyGetButton
												...
												className="flex items-center self-center justify-center w-1/2 mb-2! text-center bg-gray-300
												border-2 border-black rounded-lg cursor-pointer hover:border-white gap-x-2"
